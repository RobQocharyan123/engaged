  ...
  return (
    <div className="countdown">
      ...
      <div className="countdownText">
        <p>Ընկերներ և բարեկամներ</p>
        <p>
          Մեր կյանքում կարևոր իրադարձություն է սպասվում։ Մենք ընտանիք ենք
          կազմում և ցանկանում ենք Ձեզ հետ կիսել մեր կյանքի լուսավոր օրը։
        </p>

        <p>Հրավիրում ենք Ձեզ մեր հարսանիքին։</p>
        <p>18 Հուլիսի</p>
        <p>2025</p>
      </div>
    </div>
